package type366.config

import type366.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/paytm.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/paytm.properties")),
                "${dir}/paytm.properties containing externalized datasource properties must exist"
    }
